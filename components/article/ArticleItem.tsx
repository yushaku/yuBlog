      ...
      <section className="flex flex-col rounded-xl dark:bg-dark_subBackground">
        <Link href={`/notion/${id}`}>
          <div className="cursor-pointer">
            <Image src={image} alt={title} width={320} height={190} className="rounded-lg" loading="lazy" />
            <div className="px-4 pt-2 pb-4">
              <h1 className="text-lg line-clamp-2 font-semibold dark:text-dark_accentColor">{title}</h1>
