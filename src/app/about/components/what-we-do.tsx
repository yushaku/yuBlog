...
export function WhatWeDo() {
  return (
    <div className='px-2 sm:px-4 lg:px-10 mt-10'>
      <div className='bg-sidebar my-7 mt-14 p-2 py-5 sm:p-5 rounded-2xl'>
        <h2 className='font-display flex items-center gap-x-1 text-xl text-start font-bold  text-foreground sm:text-4xl my-1'>
          <svg
            stroke='currentColor'
            fill='currentColor'
            strokeWidth='0'
        ...
        <p className=' mt-10 hidden sm:flex  text-foreground'>
        ...
        <p className='mt-2 flex items-center'>
          ...
          I&lsquo;m open for freelance projects, feel free to text me to see how
          can we collaborate.
        </p>
