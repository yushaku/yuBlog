            ...
            <div className='w-full flex-col justify-center items-start gap-8 flex'>
              <div className='flex-col justify-start lg:items-start items-center gap-4 flex'>
                ...
                <div className='w-full flex-col justify-start lg:items-start items-center gap-3 flex'>
                  ...
                  <p className='text-gray-300 text-base font-normal leading-relaxed lg:text-start sm:text-center'>
                    I&apos;m Saif Ur Rehman I&lsquo;ve been working in web
                    development for over 2 years (and if you count the sleepless
                    nights,
                    <span className='text-primaryColor px-1.5'>
                      it’s easily 3!
                    </span>
                    ) doing both
                    <span className='text-primaryColor px-1.5'>frontend</span>
                    (The stuff you see on the screen) and
                    <span className='text-primaryColor px-1.5'>backend</span>
              ...
              <div className='w-full flex-col justify-center items-start gap-6 flex'>
                <div className='w-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1'>
                  <div className='w-full h-full p-3.5 rounded-2xl bg-neutral-800 border border-neutral-700 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex'>
