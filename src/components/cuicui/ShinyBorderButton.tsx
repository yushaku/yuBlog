...
export const ShinyBorderButton = ({
  ...
  return (
    <button
      className={cn(
        "group relative overflow-hidden rounded-full bg-sidebar/90 p-px transition-transform active:scale-95",
        className
      )}
      type='button'
      {...props}
    >
      ...
      <span className='relative z-10 block rounded-full bg-card/90  px-3 py-1'>
        <motion.span
          animate={{
            backgroundImage: [
